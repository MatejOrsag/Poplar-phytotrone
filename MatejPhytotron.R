...
#Read data
gdat<-read.delim('gasometry_M.csv',header=T,sep=';')
bdat<-read.delim('biometric.csv',header=T,sep=',')
...
tiff(filename="PreHWdataAsat.tif", width=1240, height=560, units='px', type='cairo')
